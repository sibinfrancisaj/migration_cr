...
describe('GET /api/v1/groups', () => {
  ...
  it('returns 500 when service throws unexpected error', async () => {
    mockListGroups.mockRejectedValueOnce(new Error('DB error'));
...
describe('POST /api/v1/groups/:groupId/join', () => {
  ...
  it('returns 200 when joining successfully', async () => {
  ...
  it('returns 403 when group is invite-only', async () => {
...
describe('DELETE /api/v1/groups/:groupId/leave', () => {
  ...
  it('returns 200 when leaving successfully', async () => {
...
describe('GET /api/v1/groups/:groupId/members', () => {
  ...
  it('returns 200 with members list', async () => {
    mockGetGroupMembers.mockResolvedValue([{ userId: USER_ID, name: 'Rahul', role: 'MEMBER' }]);
  ...
  it('returns 403 when caller is not a member', async () => {
    mockGetGroupMembers.mockRejectedValueOnce(new NotGroupMemberError());
...
describe('GET /api/v1/groups/:groupId/events', () => {
  ...
  it('returns 200 with events list', async () => {
    mockGetGroupEvents.mockResolvedValue([{ id: 'event-1', title: 'Meetup' }]);
